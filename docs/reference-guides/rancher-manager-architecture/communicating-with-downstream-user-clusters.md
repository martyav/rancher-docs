...
> The authorized cluster endpoint only works on Rancher-launched Kubernetes clusters. It is not available for imported clusters, or for clusters in a hosted Kubernetes provider, such as Amazon's EKS.
